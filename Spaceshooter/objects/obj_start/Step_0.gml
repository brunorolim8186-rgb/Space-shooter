...
{
    // Atualiza sprite
    if global.controler_button_select == obj_start
    {
        sprite_index = spr_botao_start_pressed;
    }
    else
    {
    ...
    if global.controler_button_select == obj_start && gamepad_button_check_pressed(0, gp_face1)
    {
    ...
    if room == rm_titlescreen && global.controler_button_select == obj_start && global.controller_axis_button_pressable == 1
    {
...
// Inicializa a seleção de botão baseado na sala
